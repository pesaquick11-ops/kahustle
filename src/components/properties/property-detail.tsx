...
export default function PropertyDetail({ vehicle, canViewSellerContact }: Props) {
  return (
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-5">
            <PropertyGallery images={vehicle.images ?? []} />
          ...
          <div className="space-y-4">
            <PropertySeller seller={vehicle.seller} canView={canViewSellerContact} />
          </div>
        </div>
        ...
        {!!vehicle.relatedVehicles?.length && (
            <div className="pt-4 border-t border-border">
              ...
              <PropertiesGrid vehicles={vehicle.relatedVehicles} />
            </div>
        )}
      </div>
  )
