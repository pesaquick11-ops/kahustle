...
export default function VehicleDetail({ vehicle, canViewSellerContact }: Props) {
  return (
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <div className="space-y-4">
            <VehicleSeller seller={vehicle.seller} canView={canViewSellerContact} />
          </div>
        </div>
        ...
        {!!vehicle.relatedVehicles?.length && (
            <div className="pt-4 border-t border-border">
              ...
              <VehiclesGrid vehicles={vehicle.relatedVehicles} />
            </div>
        )}
      </div>
  )
