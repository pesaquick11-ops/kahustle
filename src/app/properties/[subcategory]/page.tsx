...
const subcategoryMap: Record<string, { name: string; displayName: string }> = {
    apartments: { name: "apartments & flats", displayName: "Apartments & Flats" },
    houses: { name: "houses", displayName: "Houses" },
    commercial: { name: "commercial property", displayName: "Commercial Property" },
    plots: { name: "plots & land", displayName: "Plots & Land" },
}
